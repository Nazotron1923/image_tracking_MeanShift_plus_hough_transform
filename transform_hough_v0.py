...
while(1):
	...
	if ret == True:
		...
		if k == 27:
			...
			cv2.imwrite('h_Video_{}_Frame_{}.png'.format(video_name, cpt), frame_tracked)
			cv2.imwrite('h_Video_{}_filtered_Frame_{}.png'.format(video_name, cpt), filtered)
		# if cpt in CCPT:
		# 	cv2.imwrite('h_Video_{}_Frame_{}.png'.format(video_name, cpt), frame_tracked)
		# 	cv2.imwrite('h_Video_{}_filtered_Frame_{}.png'.format(video_name, cpt), filtered)
